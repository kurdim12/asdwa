    ...
    return (
        <section ref={ref} className="h-screen w-full relative overflow-hidden flex items-center justify-center">
            ...
            <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-full z-0 pointer-events-none overflow-hidden">
                <iframe
                    className="absolute top-1/2 left-1/2 min-w-full min-h-full w-[300%] h-[300%] -translate-x-1/2 -translate-y-1/2 opacity-60 grayscale pointer-events-none"
                    src="https://www.youtube.com/embed/EDKuZlFULe4?autoplay=1&mute=1&controls=0&loop=1&playlist=EDKuZlFULe4&showinfo=0&rel=0&iv_load_policy=3&modestbranding=1&disablekb=1&fs=0&playsinline=1"
